import os
from funciones import mostrar_datos_clases, mostrar_datos_zoo, listar_por_caracteristica, listar_por_clase

datos_clases = mostrar_datos_clases('Python/Ejercicio A/Ejercicio/clases.csv')
datos_animales = mostrar_datos_zoo('Python/Ejercicio A/Ejercicio/zoo.csv')
...
while True:
    ...
    if opcion == '1':
        ...
        if clase_id in datos_clases:
            ...
            animales = listar_por_clase(datos_animales, clase_id)
        ...
        animales = listar_por_caracteristica(datos_animales, caracteristica)
